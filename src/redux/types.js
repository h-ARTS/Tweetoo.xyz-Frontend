...
export const REMOVE_CACHED_IMAGE = 'REMOVE_CACHED_IMAGE';
export const CLEAR_CACHED_TWEET_IMAGES = 'CLEAR_CACHED_TWEET_IMAGES';
// UI reducer types
...
export const UPLOAD_TWEET_IMAGES_FOR_CACHE = 'UPLOAD_TWEET_IMAGES_FOR_CACHE';
export const SAVE_UNIQUE_TWEET_IMAGE_IDS = 'SAVE_UNIQUE_TWEET_IMAGE_IDS';
// Reply reducer types
